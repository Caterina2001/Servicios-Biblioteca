...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #174379">
  ...
  <div class="container-fluid">
    ...
    <a href="../UM/registros.php" class="navbar-brand" style="color: white">ISFODOSU</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <!-- Link -->
        <li class="nav-item">
          <a class="nav-link" href="../UM/excel.php" aria-hidden="true">Descargar archivo Excel</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="../UM/informe.php" aria-hidden="true">Informe</a>
        </li>
...
<!-- Navbar -->
  ...
  <br>
    ...
    <div>
      <button type="button" class="AgregarB btn-success" data-toggle="modal" data-target="#createum">
...
$conexion=mysqli_connect("localhost","root","","r_user");               
$SQL=mysqli_query($conexion,"SELECT participantes.id, participantes.recinto, participantes.nombre, participantes.rol, participantes.matricula, participantes.servicio, participantes.fecha FROM participantes where  participantes.recinto = 'UM' ");
