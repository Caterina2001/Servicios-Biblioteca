...
<div class="modal fade" id="createeph" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<form  action="" method="POST">
                            <div class="form-group">
                               <select class="css-input btn-block" style= " display: block; width: 100%;"  name="recinto" required id="recinto"  > 
                                <option value="EPH"  selected >EPH</option>
                                </select>
                            </div>
                            <br>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <option value="" hidden selected >Servicio</option>
                                    ...
                                    <option value="Saln de Equipos">Sala de Lectura</option>
